...
class open_RscControlsGroup {
    ...
    class VScrollBar : open_RscScrollBar
    {
        width = 0.021;
        autoScrollEnabled = 1;
    };

    class HScrollBar : open_RscScrollBar
    {
        height = 0.028;
    };
...
class open_RscControlsGroupNoScrollbars : open_RscControlsGroup {
...
class open_RscListNBox
{
    ...
    autoScrollDelay = 5;
    autoScrollRewind = 0;
    class ListScrollBar: open_RscScrollBar{};
    class ScrollBar: open_RscScrollBar{};
};
...
class open_RscLine: open_RscText {
    idc = -1;
    style = 176;
    x = 0.17;
    y = 0.48;
...
class open_RscTitle: open_RscText {
    style = 0;
    sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
    colorText[] = {0.95, 0.95, 0.95, 1};
};

class open_RscPicture {
    shadow = 0;
    type = 0;
    style = 48;
    sizeEx = 0.023;
...
class open_RscTextMulti: open_RscText
{
    linespacing = 1;
    style = 0 + 16 + 0x200;
};

class open_RscPictureKeepAspect : open_RscPicture
{
    style = 0x30 + 0x800;
};

class open_RscStructuredText {
    type = 13;
    style = 0;
    x = 0;
    y = 0;
...
class open_RscButtonTextOnly : open_RscButton {
    SizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
    colorBackground[] = {1, 1, 1, 0};
...
class open_RscButtonMenu : open_RscShortcutButton {
    idc = -1;
    type = 16;
    style = "0x02 + 0xC0";
    default = 0;
...
class open_RscShortcutButtonMain : open_RscShortcutButton {
    idc = -1;
    style = 0;
    default = 0;
    w = 0.313726;
...
class open_RscSlider {
    h = 0.025;
    color[] = {1, 1, 1, 0.8};
    colorActive[] = {1, 1, 1, 1};
};

class open_RscXSliderH
{
    style = 1024;
    type = 43;
    shadow = 2;
...
class open_RscBackground: open_RscText {
    type = 0;
    IDC = -1;
    style = 512;
    shadow = 0;
...
class open_RscCombo {
    ...
    class ComboScrollBar : open_RscScrollBar {};
};

class open_RscToolbox {
    colorText[] = {0.95, 0.95, 0.95, 1};
    color[] = {0.95, 0.95, 0.95, 1};
